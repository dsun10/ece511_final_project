...
def setUnifiedParams(args, system):
    for cpu in system.cpu:
        ...
        # scheduler
        cpu.scheduler = UnifiedScheduler()
        ...
        # intiq1
        cpu.scheduler.IQs[0].oports[2].rp = [IntRD(2, 0), IntRD(3, 0)]
        cpu.scheduler.IQs[0].oports[3].rp = [IntRD(2, 1), IntRD(3, 1)]

        # intiq2
        cpu.scheduler.IQs[0].oports[4].rp = [IntRD(4, 0), IntRD(5, 0)]
        cpu.scheduler.IQs[0].oports[5].rp = [IntRD(4, 1), IntRD(5, 1)]
...
if __name__ == '__m5_main__':
    ...
    setUnifiedParams(args, test_sys)
